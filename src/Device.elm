module Device exposing (Device(..), DeviceConfig, Orientation(..), WindowType(..), fromPixel)
...
getWindowType pixel =
    ...
    else if pixel < 1024 then
        Small

    else if pixel < 1440 then
        Medium

    else if pixel < 1920 then
        Large
