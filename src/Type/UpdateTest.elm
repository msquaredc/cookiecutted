module Type.UpdateTest exposing (Car, CarBuilder, CarView, Chef, ChefBuilder, ChefView, Db, DbBuilder, DbView, Foo, FooBuilder, Person, PersonBuilder, PersonView, Timestamp, car, chef, db1, flip, foo, person, timestamp)
